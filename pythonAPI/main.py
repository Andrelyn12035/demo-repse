...
def pdf_to_png(pdf_path):
    ...
    images = convert_from_path(pdf_path, poppler_path = r"C:\Users\KRAND\Downloads\poppler-24.02.0\Library\bin")
    return images
...
def pdf2image(req: File) -> str:
    ...
    images = convert_from_bytes(bytes, poppler_path = r"C:\Users\KRAND\Downloads\poppler-24.02.0\Library\bin")
